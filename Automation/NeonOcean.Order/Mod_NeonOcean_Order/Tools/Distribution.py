...
def SendToNOModInstaller (archiveFilePath: str, additionalDirectoryPath: str) -> None:
	...
	installerApplication = Applications.GetApplication("NOModInstaller")  # type: Applications.Application
...
BuildInstallerApplications = { "MSBuild": _BuildInstallerMSBuild }  # type: typing.Dict[str, typing.Callable]
