...
ModuleRootPath = None  # type: str
UserDataPath = None  # type: str

ModsPath = None  # type: str
SavesPath = None  # type: str
DebugPath = None  # type: str
PersistentPath = None  # type: str
...
def _GetModuleRootPath () -> str:
	pathPartCount = __name__.count(".") + 1  # type: str
...
def _Setup () -> None:
	global ModuleRootPath, UserDataPath, ModsPath, SavesPath, DebugPath, PersistentPath
